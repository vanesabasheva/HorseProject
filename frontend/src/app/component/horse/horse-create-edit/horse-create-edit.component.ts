...
export class HorseCreateEditComponent implements OnInit {
  ...
  public onSubmit(form: NgForm): void {
    ...
    if (form.valid) {
      ...
      observable.subscribe({
        ...
        error: error => {
          console.error(`Error for ${this.modeActionFinished} horse`, error);
  ...
  private showError(message: string) {
    // TODO: Add code to show an error message to the user, e.g., using a snackbar or toast notification
    console.error(`Error: ${message}`);
  }
